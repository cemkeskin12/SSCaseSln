...
HtmlNodeCollection nodeCollection = document.DocumentNode.SelectNodes(@"//div[@class=""uiBox showcase""]/ul/li/a/span");

foreach (var nodes in nodeCollection)
{

    //var link = nodes.Attributes["class"].Value;
    listData.Add(nodes.InnerText);
